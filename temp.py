...
st.markdown("<h1 style ='text-align: center; color: white;'>🗽Histórico de disparos en Nueva York </h1>", unsafe_allow_html =True)
...
c1.markdown("<h3 style ='text-align: center; color: white;'>Top sexo</h3>", unsafe_allow_html =True)
...
c2.markdown("<h3 style ='text-align: center; color: white;'>Top Raza</h3>", unsafe_allow_html =True)
...
c3.markdown("<h3 style ='text-align: center; color: white;'>Top edad</h3>", unsafe_allow_html =True)
...
c4.markdown("<h3 style ='text-align: center; color: white;'>Top barrios</h3>", unsafe_allow_html =True)
...
c5.markdown("<h3 style ='text-align: center; color: white;'>Top Hora</h3>", unsafe_allow_html =True)
...
c1.markdown("<h3 style ='text-align: center; color: white;'>Donde han ocurrido disparos en NY </h3>", unsafe_allow_html =True)
year =  c1.slider('Año en que ocurrio el suceso', int(df.year.min()), int(df.year.max()))
c1.map(df[df['year'] == year][['latitude','longitude']])

c2.markdown("<h3 style ='text-align: center; color: white;'>Horas en que han ocurrido disparos en NY </h3>", unsafe_allow_html =True)
Hour =  c2.slider('Hora en que ocurrio el suceso', int(df.hour.min()), int(df.hour.max()))
df2= df[df['hour']==Hour]


c2.write(pdk.Deck(map_style = 'mapbox://styles/mapbox/light-v9',
    initial_view_state= {
...
fig.update_layout(title_x=0.5,template = 'simple_white',
                  ...
                  legend=dict(
                      ...
                      y=1.02,xanchor="right",x=0.7))
st.plotly_chart(fig)
#----------------------

c4, c5, c6, c7 = st.columns((1,1,1,1))
c4.markdown("<h3 style ='text-align: center; color: white;'>Edad de los asaltantes </h3>", unsafe_allow_html =True)
...
df2['perp_age_group2'] = df2['perp_age_group'].replace({'<18':'1','18-24':'2','24-44':'3','45-64':'4', '65+':'5', 'N/A':'6'})
df2 = df2.sort_values('perp_age_group2')
fig = px.bar(df2, x='Disparos', y='perp_age_group', orientation ='h', width=380, height =370)
fig.update_layout(xaxis_title="<b>Atacante<b>",yaxis_title="<b>Edades<b>",
                  template = 'simple_white',plot_bgcolor='rgba(0,0,0,0)')
c4.plotly_chart(fig)

#------------------------

c5.markdown("<h3 style ='text-align: center; color: white;'>Edad de las victimas </h3>", unsafe_allow_html =True)
...
df2['vic_age_group2'] = df2['vic_age_group'].replace({'<18':'1','18-24':'2','24-44':'3','45-64':'4', '65+':'5', 'N/A':'6'})
df2 = df2.sort_values('vic_age_group2')
fig = px.bar(df2, x='Disparos', y='vic_age_group', orientation ='h', width=380, height =370)
fig.update_layout(xaxis_title="<b>Victima<b>",yaxis_title="<b>Edades<b>",
                  template = 'simple_white',plot_bgcolor='rgba(0,0,0,0)')
c5.plotly_chart(fig)

#-----------------
c6.markdown("<h3 style ='text-align: center; color: white;'> sexo del atacanta </h3>", unsafe_allow_html =True)
...
c7.markdown("<h3 style ='text-align: center; color: white;'> sexo de la victima </h3>", unsafe_allow_html =True)
...
st.markdown("<h3 style ='text-align: center; color: white;'> Horas con mas y menos disparos </h3>", unsafe_allow_html =True)
...
if st.checkbox('obtener disparos por fecha y barrio', False):
